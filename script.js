...
async function translateText() {
  ...
  let from = document.getElementById("fromLang").value; // küçük harf (tr, en)
  let to = document.getElementById("toLang").value;     // küçük harf (tr, en)
  ...
  try {
    ...
    let translated = data.responseData.translatedText || "❌ Çeviri yapılamadı";
